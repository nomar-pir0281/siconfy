                ...
                {calculations.map((calc, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                      {typeof calc.resultado === 'number' ? formatCurrency(calc.resultado) : typeof calc.resultado === 'object' ? JSON.stringify(calc.resultado, null, 2) : calc.resultado}
                    </td>
          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white" onClick={e => e.stopPropagation()}>
            <div className="mt-3">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <strong>Resultado:</strong> {typeof selectedCalculation.resultado === 'number' ? formatCurrency(selectedCalculation.resultado) : typeof selectedCalculation.resultado === 'object' ? JSON.stringify(selectedCalculation.resultado, null, 2) : selectedCalculation.resultado}
                </div>
                <div>
